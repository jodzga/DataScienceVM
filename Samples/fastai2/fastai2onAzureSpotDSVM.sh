#!/bin/bash
# Script to create Azure DSVM instance and install fast.ai library
...
az vm create --name $vmname -g $vmname --image microsoft-dsvm:ubuntu-1804:1804:latest --priority Low --eviction-policy Deallocate --size Standard_NC6s_v3 --storage-sku StandardSSD_LRS --admin-user fastuser --admin-password $password

...
az vm create --name $vmname -g $vmname --image microsoft-dsvm:ubuntu-1804:1804:latest --size Standard_NC6s_v3 --storage-sku StandardSSD_LRS --admin-user fastuser --admin-password $password
